...
// FeedbackTab dipindahkan ke file terpisah agar AdminDashboard.js lebih ringkas
import FeedbackTab from './admin/tabs/FeedbackTab';
import CMSTab from './admin/tabs/CMSTab';
// resolveFileUrl terpusat di utils/api.js — tidak perlu didefinisikan ulang di sini
...
// resolveFileUrl sudah dipindah ke utils/api.js dan diimport di atas
...
const AdminDashboard = () => {
  ...
  return (
    <div className="admin-dashboard-clean">
      ...
      {/* ====== TAB CMS (GLOBAL ADMIN ONLY) ====== */}
      {tab === 'cms' && isSuperAdmin && (
        <CMSTab />
      )}
